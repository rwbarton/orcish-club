...
\begin{figure}[h]
\begin{tabular}{ll}
1\s & At least one long minor, with a 4-card major possible.\\
2\c & Both majors.\\
2\d & One major, 6+.\\
2M & 5+M, 4+m.\\
2\nt & 6 card minor any quality, almost enough for 1\h.\\
...
With a semi-positive hand (a good 6 to 8), responder has two options: ``raise'' the artificial bid, showing a specified shape, or use an artificial inquiry.  All other bids show less than semi-positive.
...
2\nt\ seems not to exist.  (maybe it should be canape with long clubs?)
...
\subsection{1\c--1\d--1\h--1\s--3\c}
If responder does not pass now, a game force is created.

\subsection{Openers artificial rebids over 1\c - 1\d}
...
&&& 3oM &&& Weak, long suit.\\
&&& 3\nt &&& To play.\\
1\c & 1\d & 2\nt &&&& 6 card minor, any quality, almost strong enough for 1\h.\\
&&& 3\c &&& Pass or correct.\\
...
\begin{figure}[p]
\begin{tabular}{cccl}
1\c & (x) & -- & 7-8\hcp, not interested in 1\c xx\\
1\c & (x) & xx & 7-8\hcp, 4\+ \c, interested in penalizing?\\
1\c & (x) & 1\d & 0-6\hcp\\
...
1\nt\\
&2\c &&& Stayman.\\
&   &2\d && No 4 card \h\ or \s.\\
&   &   &2\h & Weak, 4+4+ in majors.\\
&   &   &2\s &Invite+, 5\s, 4\h.\\
&   &   &2\nt &Invite.\\
&   &   &3m &Invite with long minor.\\
&   &   &3M & \gf, 4M, short OM.\\
&   &   &3\nt &To play.\\
&   &   &4m &5+5+ in majors, splinter.\\
&   &   &4M &To play.\\
&   &2\h && 4\h.\\
&   &   &2\s & Invite w/o 4\s OR slam try in \h. (2\nt = min)\\
&   &   &2\nt & Invite w/ 4\s. \\
&   &   &3m & Invite with long minor. \\
&   &   &3\h & Invite with 4\h. \\
&   &   &3\s & Slam try with 4\s.\\
&   &   &3\nt & To play, with 4\s.\\
&   &   &4m& Splinter for \h.\\
&   &   &4M& To play.\\
&   &2\s && 4\s, not 4\h.\\
...
&   &   &4m& \h\ fit, control.\\
&   &   &4M& To play.\\
&   &2\nt&& 3+3+ majors and min, or 44 majors and max.\\
&   &   &3m& Sets corresponding major, frivolous on.\\
&   &   &3M& Invite, 5 card M.\\
&   &   &4M& To play.\\
&   &3\c&& max, 4+\c, 2\d.\\
&   &   &\hbox to 0pt{3M,4\c}& sets trump.\\
&   &   &4\d & 1430 for \c.\\
&   &3\d&& max, 4+\d, 2\c.\\
&   &   &\hbox to 0pt{3M,4\d}& sets trump.\\
&   &   &4\c &1430 for \d.\\
&   &3\h&& max, 3433.\\
&   &3\s&& max, 4333.\\
&   &3\nt&& max, 33(43).\\
\end{tabular}
\caption{Stayman and Hitchhiker}
\end{figure}
\begin{figure}
\begin{tabular}{llllllll}
&2M&&&&&& To play. (2M+1 superaccept)\\
&2\nt&&&&&& Transfer to clubs.\\
&   &3\c&\hbox{3\d, 3M}&&&& 6\c, 4 other suit, slammish.\\
&3\c&&&&&& Transfer to diamonds.\\
&   &3\d&3M&&&& 6\d, 4M, slammish.\\
&3\d&&&&&& 16-19\hcp, 5-7 \ak, 44(50) or (43)(60).  (opposite 13-14 and 13-15 adjust)\\
&   &3\h&&&&& relay.\\
&   &   &3\s&&&& clubs.\\
&   &   &   &3\nt&&& To play. (4\c=7\ak)\\
&   &   &   &4\c &&& Shape ask.\\
&   &   &   &   &4\d && 4405.\\
&   &   &   &   &   &4M & To play.\\
&   &   &   &   &   &4\nt & Control ask.  Zoom to spiral scan.\\
&   &   &   &   &4\h && 3406, 5-6 \ak.\\
&   &   &   &   &   &4\s & Control ask.  Zoom to spiral scan.\\
&   &   &   &   &4\s && 4306, 5-6 \ak.\\
&   &   &   &   &   &4\nt & Control ask.  Zoom to spiral scan.\\
&   &   &   &   &4\nt&& 3406, 7\ak. (5\c = to play, 5\d=spiral scan)\\
&   &   &   &   &5\c&& 4306, 7\ak, no Q\c. (5\d=spiral scan)\\
&   &   &   &4\d&&& Control ask. (4\h=5, 4\s=6, 4\nt=7 \& no Q\c\ldots)\\
&   &   &   &\hbox to 0pt{4M, 5\c}&&& To play.\\
&   &   &3\nt&&&& 4450, 5-6\ak.\\
&   &   &   &4\c &&& Shape ask.\\
&   &   &   &   &4\d && 4450.\\
&   &   &   &   &   &4M & To play.\\
...
&   &   &   &   &4\s && 4360, 5 \ak.\\
&   &   &   &   &   &4\nt & Spiral scan.\\
&   &   &   &   &4\nt&& 3460, 6\ak. (5\c = spiral scan, 5\d=to play)\\
&   &   &   &   &5\c&& 4360, 6\ak, no Q\d. (5\h=spiral scan)\\
&   &   &   &   &5\d&& 4360, 6\ak, Q\d. (5\h=spiral scan)\\
&   &   &   &4\d&&& Control ask. (4\h=5, 4\s=6 no Q\d\ldots)\\
&   &   &   &\hbox to 0pt{4M, 5\d}&&& To play.\\
&   &   &4\c&&&& 4450, 7\ak\ OR (43)60.\\
&   &   &   &4\d&&& Shape ask.\\
&   &   &   &   &4\h&& 3460.\\
&   &   &   &   &   &4\s & Control ask.  Zoom to spiral scan.\\
&   &   &   &   &4\s&& 4360.\\
&   &   &   &   &   &4\nt & Control ask.  Zoom to spiral scan.\\
&   &   &   &   &4\nt&& 4450, no Q\d. (5\c = spiral scan, 5\d=to play)\\
&   &   &   &   &5\c&& 4450, Q\d. (5\h= spiral scan)\\
&   &   &   &\hbox to 0pt{4M, 5\d} &&& To play.\\
&3M &&&&&& 3M, 1OM, (54) minors, \gf.\\
&3\nt&&&&&& To play.\\
&4m&&&&&& 6+ corresponding major, slammish.\\
&4M&&&&&& To play.\\
\end{tabular}
\caption{Higher bids over 1\nt}
\end{figure}
