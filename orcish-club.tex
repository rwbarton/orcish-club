...
We modify the 2\nt\ relay in one way: when responder has a maximum
hand with (43) in the majors, he bids the suit above his major, so
that he does not declare a contract in that major (with his exact
shape and strength known).
